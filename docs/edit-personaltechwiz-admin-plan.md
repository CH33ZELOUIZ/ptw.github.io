# edit.personaltechwiz.com admin editor plan

Goal: temporary authenticated admin portal for editing PersonalTechWiz site text without putting edit controls or tokens in the public GitHub Pages site.

## Safe architecture

- Keep `personaltechwiz.com` as the public static GitHub Pages site.
- Run a separate private admin app on the homeserver, exposed as `edit.personaltechwiz.com` only after authentication.
